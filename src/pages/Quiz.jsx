...
const Quiz = () => {
  ...
  const getSampleQuestions = (topic) => {
    return [
      {
        id: 1,
        question: `What is the fundamental concept of ${topic || "programming"}?`,
        options: [
      ...
      {
        id: 2,
        question: `Which approach is best for learning ${topic || "new skills"}?`,
        options: [
          "Reading only",
  ...
  const getPerformanceLevel = () => {
    ...
    if (percentage >= 80) return { label: "Expert", color: "text-emerald-600", bg: "bg-emerald-100" };
    if (percentage >= 60) return { label: "Intermediate", color: "text-blue-600", bg: "bg-blue-100" };
    if (percentage >= 40) return { label: "Beginner", color: "text-amber-600", bg: "bg-amber-100" };
    return { label: "Needs Improvement", color: "text-rose-600", bg: "bg-rose-100" };
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-card border border-border rounded-2xl p-8 shadow-lg">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Test your knowledge and track your progress with this comprehensive quiz.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-background border border-border rounded-lg p-4">
                ...
                <p className="text-3xl font-bold text-foreground">{questions.length * 2} min</p>
              </div>
              <div className="bg-background border border-border rounded-lg p-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
              <h3 className="font-semibold text-foreground mb-3">Quiz Instructions:</h3>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-card border border-border rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
              ...
              <div className={`${performance.bg} border border-border rounded-lg p-6 text-center`}>
            ...
            <div className="bg-background border border-border rounded-lg p-6 mb-6">
              <h3 className="font-semibold text-foreground mb-4 text-lg">Question Review</h3>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Your answer: <span className={isCorrect ? "text-emerald-600" : "text-rose-600"}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between">
          ...
          <Button
            ...
            className="disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {allQuestionsAnswered() ? "Submit Quiz" : `Answer ${questions.length - answeredCount} more`}
          </Button>
        </div>
